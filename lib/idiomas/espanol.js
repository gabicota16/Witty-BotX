...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE WITTYBOT 🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return ' 𝐒𝐮𝐩𝐞𝐫 𝐖𝐢𝐭𝐭𝐲-𝐁𝐨𝐭 - 𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 '} 
...
const eWittyTickets = () => { return '🎫 Witty Tickers' } 
...
const smsModAd2 = () => { return `Solo los Admins podrán usar WittyBot en Grupos`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎, 𝘿𝙄𝙎𝙁𝙍𝙐𝙏𝘼 𝘿𝙀 𝙒𝙄𝙏𝙏𝙔𝘽𝙊𝙏!!!\n\n💖 𝙒𝙄𝙏𝙏𝙔𝘽𝙊𝙏 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
