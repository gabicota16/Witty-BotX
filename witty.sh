...
if wget -q https://github.com/gabicota16/Witty-Bot/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/gabicota16/Witty-Bot\ncd Witty-Bot\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/gabicota16/Witty-Bot.git
...
menu() {
	...
	printf "\n"
	printf "${v1}[${b}01${v1}]${v} Instagram del creador\n"
	printf "\n"
...
menu_ayuda() {
    #printf "${v1}[${b}++${v1}]${v} Witty-Bot${b}: "
	read opcion
	case $opcion in
            01|1)
                am start -a android.intent.action.VIEW https://instagram.com/gabrielacosta_15 &>> /dev/null
                echo -e "${b}[${v1}++${b}]${v} Direccionando\n"
...
echo -e "\033[01;32m\033[01mIniciando WittyBot!!\nStarting WittyBot!!\n\033[0m"
npm start
